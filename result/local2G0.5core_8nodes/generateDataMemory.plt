...
plot "generateDataMemory.data" using 1:2 with linespoints lw 4 pt 0 ps 0, \
	...
	"generateDataMemory.data" using 1:5 with linespoints lw 4 pt 0 ps 0, \
	"generateDataMemory.data" using 1:6 with linespoints lw 4 pt 0 ps 0, \
	"generateDataMemory.data" using 1:7 with linespoints lw 4 pt 0 ps 0, \
	"generateDataMemory.data" using 1:8 with linespoints lw 4 pt 0 ps 0, \
	"generateDataMemory.data" using 1:9 with linespoints lw 4 pt 0 ps 0, \
	"generateDataMemory.data" using 1:10 with linespoints lw 4 pt 0 ps 0
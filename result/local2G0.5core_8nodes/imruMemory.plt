...
set output "imruMemory.eps"
#set term x11 0
set boxwidth 0.9 absolute
set key inside left bottom vertical noreverse noenhanced autotitles nobox
...
plot "imruMemory.data" using 1:2 with linespoints lw 4 pt 0 ps 0, \
	...
	"imruMemory.data" using 1:10 with linespoints lw 4 pt 0 ps 0